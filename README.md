...
**v0.1.0** — initial release: 65 CLI commands, 85 MCP tools, a persistent
daemon, and a self-checking CLI test harness (`scripts/cli-smoke.sh`). Pre-built
binaries and a crates.io release are on the roadmap.
